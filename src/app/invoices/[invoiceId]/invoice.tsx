...
//         <DialogHeader>
//           <DialogTitle className="text-2xl">Refund Money?</DialogTitle>
//           <DialogDescription>
//             This action cannot be undone. It will refund the payment and mark this invoice as <strong>void</strong>.
//           </DialogDescription>
//         </DialogHeader>
//         <DialogFooter>
//         <form action={updateStatusToVoidAction} className="w-full flex justify-center gap-2">
//   <input type="hidden" name="id" value={invoice.id.toString()} />
